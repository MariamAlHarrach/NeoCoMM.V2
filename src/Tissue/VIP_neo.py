...
class VIPcell:
    ...
    def updateParameters(self):
        self.m_inf = self.m_inf_BIS((self.y[0] + self.Vtm_s))
        self.alpha_h = self.alpha_h_BIS((self.y[0] + self.Vtm_s))
        self.alpha_n = self.alpha_n_BIS((self.y[0] + self.Vtm_s))
        self.beta_h = self.beta_h_BIS((self.y[0] + self.Vtm_s))
        self.beta_n = self.beta_n_BIS((self.y[0] + self.Vtm_s))

        self.I_Na = self.I_Na_BIS(self.g_Na, self.m_inf, self.y[1], (self.y[0] + self.Vtm_s), self.E_Na)
        self.I_K = self.I_K_BIS(self.g_K, self.y[2], (self.y[0] + self.Vtm_s), self.E_K)
        self.I_leak = self.I_leak_BIS(self.g_leak, self.PERCENT, (self.y[0] + self.Vtm_s), self.E_leak)
        # ajoutIKNa
        self.I_KNa = self.I_KNa_BIS(self.g_KNa, self.y[3], (self.y[0] + self.Vtm_s), self.E_K)
