...
class lfpViewer_EEG(QMainWindow):
    def __init__(self, parent=None):
        ...
        # self.horizontalSliders  = MySlider(Qt.Orientation.Horizontal)
        ...
        self.paramPlot.setAlignment(Qt.AlignmentFlag.AlignLeft)
        l_gain = QLabel('Gain')
        ...
        self.paramPlot2.setAlignment(Qt.AlignmentFlag.AlignLeft)
...
class Sig_Managment(QDialog):
    def __init__(self, parent=None):
        ...
        self.actionbutton_l.setAlignment(Qt.AlignmentFlag.AlignTop)
...
class Filter_Management(QDialog):
    def __init__(self, parent=None):
        ...
        self.Add.setSizePolicy(QSizePolicy.Policy.Expanding, QSizePolicy.Policy.Expanding)
...
class MySlider(QScrollBar):
    ...
    def paintEvent(self, event):
        ...
        subPageRect = self.style().subControlRect(QStyle.ComplexControl.CC_ScrollBar, option, QStyle.SubControl.SC_ScrollBarSubPage, self)
        painter.drawText(subPageRect, Qt.AlignmentFlag.AlignLeft | Qt.AlignmentFlag.AlignVCenter, self.text_pre)

        # get the "addPage" rectangle and draw its text
        addPageRect = self.style().subControlRect(QStyle.ComplexControl.CC_ScrollBar, option, QStyle.SubControl.SC_ScrollBarAddPage, self)
        painter.drawText(addPageRect, Qt.AlignmentFlag.AlignRight | Qt.AlignmentFlag.AlignVCenter, self.text_post)

        # the same, for the slider
        sliderRect = self.style().subControlRect(QStyle.ComplexControl.CC_ScrollBar, option, QStyle.SubControl.SC_ScrollBarSlider, self)
        painter.drawText(sliderRect, Qt.AlignmentFlag.AlignCenter, self.text_slider)
